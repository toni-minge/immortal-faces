<p id="0." className="md:text-7xl sm:text-6xl text-5xl">Considerations</p>
...
<h3 id="1.2"> 1.2 How to store images directly on-chain (in a hacky way) </h3>
...
<h3 id="1.3"> 1.3 Why are the gas fees so high? </h3>
...
<h2 id="2."> 2. Artistic Aspects </h2>

<h3 id="2.1"> 2.1 Aura and Reproduction </h3>
...
<h3 id="2.2"> 2.2 Hanging out on servers has no aura per se</h3>
...
<h2 id="3."> 3. Sociological consideration </h2>

<h3 id="3.1">3.1 Eva Illouz Why Love Hurts </h3>
...
<h3 id="3.2"> 3.2 Being part of the market yourself</h3>
...
So, having summed up all the technical difficulties, artistic thoughts, and sociological ideas related to this project, I hope that Non-Fungible Faces does not just remain a reference to these themes mentioned. Rather, I hope that people will enjoy this project and that by participating in this project they will help make the new Internet what the old one never was - a place of freedom, equality, and transparency.
